...
The environment variable controls the behavior of the on-disk [Just-In-Time (JIT) compilation](../01-introduction/cuda-platform.html#cuda-platform-just-in-time-compilation) cache.
...
It affects only devices of [compute capability](compute-capabilities.html#compute-capabilities) 8.0 and above.

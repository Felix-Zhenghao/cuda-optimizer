...
![Asynchronous Concurrent Execution with CUDA streams](img/Figure-17-Asynchronous-COncurrent-Execution-with-CUDA-streams.png)
...
[2.4.9.2 Introduction to CUDA Graphs with Stream Capture](#async-execution-cuda-graphs), and a
more comprehensive discussion is provided in section [4.1 CUDA Graphs](../04-special-topics/cuda-graphs.html#cuda-graphs).

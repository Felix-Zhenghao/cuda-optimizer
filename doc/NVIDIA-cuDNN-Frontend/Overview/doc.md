...
| [Convolution fprop](../operations/Convolutions.html#convolution-fprop) | * `conv_fprop` * `Conv_fprop_attributes` | `conv_fprop` |
| [Convolution dgrad](../operations/Convolutions.html#convolution-dgrad) | * `conv_dgrad` * `Conv_dgrad_attributes` | `conv_dgrad` |
| [Convolution wgrad](../operations/Convolutions.html#convolution-wgrad) | * `conv_wgrad` * `Conv_wgrad_attributes` | `conv_wgrad` |
| [Matrix Multiplication](../operations/Matmul.html) | * `matmul` * `Matmul_attributes` | `matmul` |
| [Pointwise Operations](../operations/Pointwise.html#pointwise) | * `pointwise` * `Pointwise_attributes` | * `add` * `bias` * `rqsrt` * `sub` * `mul` * `scale` * `relu` * `elu` * `gelu` * `cmp_gt` |
| [Batch Normalization](../operations/Normalizations.html#batchnorm-forward) | * `batchnorm` * `Batchnorm_attributes` | `batchnorm` |
| [Batch Norm bprop](../operations/Normalizations.html#batchnorm-backward-dbn) | * `batchnorm_backward` * `Batchnorm_backward_attributes` | `batchnorm_backward` |
| [Generate stats of output](../operations/Normalizations.html#generate-stats) | * `genstats` * `Genstats_attributes` | `genstats` |
| [Batch Norm Finalize of stats](../operations/Normalizations.html#batchnorm-finalize) | * `bn_finalize` * `BN_finalize_attributes` | `bn_finalize` |
| [Dbn weight](../operations/Normalizations.html) | * `dbn_weight` * `DBN_weight_attributes` | `dbn_weight` |
| [Resampling](../operations/Resampling.html#resampling-forward) | * `resample` * `Resample_attributes` | `resample` |
| [Scale dot product attention](../operations/Attention.html#scaled-dot-product-attention-fp16bf16-forward) | * `sdpa` * `SDPA_attributes` | `sdpa` |
| [Scale dot product attention backward](../operations/Attention.html#scaled-dot-product-attention-fp16bf16-backward) | * `sdpa_backward` * `SDPA_backward_attributes` | `sdpa_backward` |
| [Scale dot product attention FP8](../operations/Attention.html#scaled-dot-product-attention-fp8-forward) | * `sdpa_fp8` * `SDPA_fp8_attributes` | `sdpa_fp8` |
| [Scale dot product attention backward FP8](../operations/Attention.html#scaled-dot-product-attention-fp8-backward) | * `sdpa_fp8_backward` * `SDPA_fp8_backward_attributes` | `sdpa_fp8_backward` |
...
Refer to the [Operations](../operations/operations.html#operations) section for more details.
...
Refer to the [Operations](../operations/operations.html#operations) section for APIs of different operation types.

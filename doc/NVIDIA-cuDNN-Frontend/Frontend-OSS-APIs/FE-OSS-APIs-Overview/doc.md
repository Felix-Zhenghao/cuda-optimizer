...
* [GEMM + Amax](gemm_fusions/gemm_amax.html)
* [GEMM + SwiGLU](gemm_fusions/gemm_swiglu.html)
* [Grouped GEMM + GLU (Unified)](gemm_fusions/grouped_gemm_glu.html)
* [Grouped GEMM + dGLU (Unified)](gemm_fusions/grouped_gemm_dglu.html)
* [Grouped GEMM + SwiGLU (Legacy, Contiguous-only)](gemm_fusions/grouped_gemm_swiglu.html)
* [Grouped GEMM + dSwiGLU (Legacy, Contiguous-only)](gemm_fusions/grouped_gemm_dswiglu.html)
* [Discrete Grouped GEMM + SwiGLU](gemm_fusions/discrete_grouped_gemm_swiglu.html)
* [Discrete Grouped GEMM + dSwiGLU](gemm_fusions/discrete_grouped_gemm_dswiglu.html)
* [Grouped GEMM + Quant (Legacy, Dense-only)](gemm_fusions/grouped_gemm_quant.html)
* [Grouped GEMM + Quant (Unified)](gemm_fusions/grouped_gemm_quant_unified.html)
* [Native Sparse Attention (NSA)](nsa.html)
* [SDPA Backward FE OSS API (SM100, D=256)](attention/sdpa_bwd_d256.html)
* [RMSNorm + SiLU](rmsnorm_silu.html)

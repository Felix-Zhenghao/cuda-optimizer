...
\(
AB12[m, n, l] = \alpha \sum\_{k} A[m, k, l] \, B[n, k, l]
\)
...
\(
C[:, \, bG:(b+1)G, \, :] = X\_b \cdot \operatorname{swish}(G\_b), \quad
...
| Format | ab\_dtype | sf\_dtype | sf\_vec\_size | Notes |
| --- | --- | --- | --- | --- |
...
* Not compatible with FP8 c\_dtype. BF16 `c_dtype` is expected.
* For MXFP8 inputs, ab12\_dtype` should be float16 or bfloat16.

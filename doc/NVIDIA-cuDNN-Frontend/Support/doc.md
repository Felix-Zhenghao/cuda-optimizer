...
5. Fill out the bug reporting page. Be descriptive and if possible, provide the steps that you are following to help reproduce the problem. If possible, paste or attach an [API log](../../../backend/v9.20.0/reference/troubleshooting.html#api-logging "(in NVIDIA cuDNN Backend)").

...
[Table 55](#tcgen05-smem-swizzle-mode)

Table 55 Layout for swizzle atoms
...
![_images/tcgen05-smem-layout-128B-32B-atom-mn.png](img/Figure-219-MN-major-128B-swizzling-with-32B-atomicity.png)

*Figure 219 MN major 128B swizzling with 32B atomicity*

![_images/tcgen05-smem-layout-128B-mn.png](img/Figure-220-MN-major-128B-swizzling.png)

*Figure 220 MN major 128B swizzling*

![_images/tcgen05-smem-layout-128B-k.png](img/Figure-221-K-major-128B-swizzling.png)

*Figure 221 K major 128B swizzling*

![_images/tcgen05-smem-layout-64B-mn.png](img/Figure-222-MN-major-64B-swizzling.png)

*Figure 222 MN major 64B swizzling*

![_images/tcgen05-smem-layout-64B-k.png](img/Figure-223-K-major-64B-swizzling.png)

*Figure 223 K major 64B swizzling*

![_images/tcgen05-smem-layout-32B-mn.png](img/Figure-224-MN-major-32B-swizzling.png)

*Figure 224 MN major 32B swizzling*

![_images/tcgen05-smem-layout-32B-k.png](img/Figure-225-K-major-32B-swizzling.png)

*Figure 225 K major 32B swizzling*

![_images/tcgen05-smem-layout-no-swizzle-mn.png](img/Figure-226-MN-major-no-swizzling-mode.png)

*Figure 226 MN major no-swizzling mode*

![_images/tcgen05-smem-layout-no-swizzle-k.png](img/Figure-227-K-major-no-swizzling-mode.png)
...
* K-Major: [Figure 228](#tcgen05-smem-layout-k)
  ...
  > ![_images/tcgen05-smem-layout-k.png](img/Figure-228-K-major.png)
  >
  > *Figure 228 K major*
* MN-Major: [Figure 229](#tcgen05-smem-layout-mn)

  > ![_images/tcgen05-smem-layout-mn.png](img/Figure-229-MN-major.png)
  >
  > *Figure 229 MN major*

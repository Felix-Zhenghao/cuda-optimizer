...
* Multiplicand A, from registers:
  ...
  >
  > ![_images/sparse-wgmma-64N32-f16-bf16-A.png](img/Figure-175-Sparse-WGMMA-m64nNk32-fragment-layout-for-matrix-A-withf16bf16type.png)
  >
  > *Figure 175 Sparse WGMMA .m64nNk32 fragment layout for matrix A with.f16/.bf16type.*
* Accumulator D:
...
* Metadata operand is a `.b32` register containing 16 2-bit vectors each storing the index of a
  ...
  > ![_images/sparse-mma-metadata-16832-f16bf16.png](img/Figure-176-Sparse-WGMMA-m64nNk32-metadata-layout-forf16bf16type.png)
  >
  > *Figure 176 Sparse WGMMA .m64nNk32 metadata layout for.f16/.bf16type.*
...
* Multiplicand A, from registers:
  ...
  >
  > ![_images/sparse-wgmma-64N16-tf32-A.png](img/Figure-177-Sparse-WGMMA-m64nNk16-fragment-layout-for-matrix-A-withtf32type.png)
  >
  > *Figure 177 Sparse WGMMA .m64nNk16 fragment layout for matrix A with.tf32type.*
* Accumulator D:
...
* Metadata operand is a `.b32` register containing eight 4-bit vectors each storing the index of a
  ...
  > ![_images/sparse-mma-metadata-16816-tf32.png](img/Figure-178-Sparse-WGMMA-m64nNk16-metadata-layout-fortf32type.png)
  >
  > *Figure 178 Sparse WGMMA .m64nNk16 metadata layout for.tf32type.*

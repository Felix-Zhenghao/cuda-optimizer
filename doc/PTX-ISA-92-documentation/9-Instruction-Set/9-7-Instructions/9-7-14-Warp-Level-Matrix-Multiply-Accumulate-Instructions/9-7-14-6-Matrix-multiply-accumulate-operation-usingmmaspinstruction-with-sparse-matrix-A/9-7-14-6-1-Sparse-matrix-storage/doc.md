...
![_images/sparse-mma-storage-example.png](img/Figure-111-Sparse-MMA-storage-example.png)
...
![_images/f16-metadata-example.png](img/Figure-112-Sparse-MMA-metadata-example-forf16bf16type.png)

*Figure 112 Sparse MMA metadata example for.f16/.bf16type.*
...
![_images/tf32-metadata-example.png](img/Figure-113-Sparse-MMA-metadata-example-fortf32type.png)

*Figure 113 Sparse MMA metadata example for.tf32type.*
...
![_images/u8s8-metadata-example.png](img/Figure-114-Sparse-MMA-metadata-example-foru8s8type.png)

*Figure 114 Sparse MMA metadata example for.u8/.s8type.*
...
![_images/u4s4-metadata-example.png](img/Figure-115-Sparse-MMA-metadata-example-foru4s4type.png)

*Figure 115 Sparse MMA metadata example for.u4/.s4type.*
...
![_images/fp8-metadata-example.png](img/Figure-116-Sparse-MMA-metadata-example-fore4m3e5m2e3m2e2m3e2m1type.png)

*Figure 116 Sparse MMA metadata example for.e4m3/.e5m2/.e3m2/.e2m3/.e2m1type.*
...
![_images/fp4-metadata-example.png](img/Figure-117-Sparse-MMA-metadata-example-fore2m1type-withkindmxf4orkindmxf4nvf4.png)

*Figure 117 Sparse MMA metadata example for.e2m1type with.kind::mxf4or.kind::mxf4nvf4*

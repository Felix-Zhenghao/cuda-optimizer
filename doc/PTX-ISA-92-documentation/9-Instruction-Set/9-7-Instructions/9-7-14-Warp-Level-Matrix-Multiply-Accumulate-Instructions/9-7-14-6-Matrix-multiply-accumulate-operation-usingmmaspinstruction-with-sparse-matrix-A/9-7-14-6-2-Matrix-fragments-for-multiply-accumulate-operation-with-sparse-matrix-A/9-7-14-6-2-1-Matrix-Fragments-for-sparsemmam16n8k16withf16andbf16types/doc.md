...
* Multiplicand A:
  ...
  ![_images/sparse-mma-16816-f16-bf16-A.png](img/Figure-118-Sparse-MMA-m16n8k16-fragment-layout-for-matrix-A-withf16bf16type.png)

  *Figure 118 Sparse MMA .m16n8k16 fragment layout for matrix A with.f16/.bf16type.*
...
* Metadata: A `.b32` register containing 16 2-bit vectors each storing the index of a non-zero
  ...
  > ![_images/sparse-mma-metadata-16816-f16bf16.png](img/Figure-119-Sparse-MMA-m16n8k16-metadata-layout-forf16bf16type.png)
  >
  > *Figure 119 Sparse MMA .m16n8k16 metadata layout for.f16/.bf16type.*

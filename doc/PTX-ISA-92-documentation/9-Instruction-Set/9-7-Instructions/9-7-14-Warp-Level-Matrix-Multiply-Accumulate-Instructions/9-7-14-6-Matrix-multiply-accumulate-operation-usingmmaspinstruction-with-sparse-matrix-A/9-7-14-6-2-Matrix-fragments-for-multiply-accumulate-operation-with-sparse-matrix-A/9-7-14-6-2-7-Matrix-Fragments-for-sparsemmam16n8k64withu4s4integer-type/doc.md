...
* Multiplicand A:
  ...
  ![_images/sparse-mma-16864-u4s4-A.png](img/Figure-138-Sparse-MMA-m16n8k64-fragment-layout-for-matrix-A-withu4s4type.png)

  *Figure 138 Sparse MMA .m16n8k64 fragment layout for matrix A with.u4/.s4type.*
...
* Metadata: A `.b32` register containing 16 2-bit vectors with each pair of 2-bit vectors storing
  ...
  > ![_images/sparse-mma-metadata-16864-u4s4.png](img/Figure-139-Sparse-MMA-m16n8k64-metadata-layout-foru4s4type.png)
  >
  > *Figure 139 Sparse MMA .m16n8k64 metadata layout for.u4/.s4type.*

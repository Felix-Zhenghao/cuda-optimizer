...
* Multiplicand A:
  ...
  ![_images/sparse-mma-16832-f16-bf16-A.png](img/Figure-120-Sparse-MMA-m16n8k32-fragment-layout-for-matrix-A-withf16bf16type.png)

  *Figure 120 Sparse MMA .m16n8k32 fragment layout for matrix A with.f16/.bf16type.*
...
* Multiplicand B:
  ...
  ![_images/sparse-mma-16832-f16bf16-B.png](img/Figure-121-Sparse-MMA-m16n8k32-fragment-layout-for-matrix-B-withf16bf16type.png)

  *Figure 121 Sparse MMA .m16n8k32 fragment layout for matrix B with.f16/.bf16type.*
...
* Metadata: A `.b32` register containing 16 2-bit vectors with each pair of 2-bit vectors storing
  ...
  > ![_images/sparse-mma-metadata-16832-f16bf16.png](img/Figure-122-Sparse-MMA-m16n8k32-metadata-layout-forf16bf16type.png)
  >
  > *Figure 122 Sparse MMA .m16n8k32 metadata layout for.f16/.bf16type.*

...
* Multiplicand A:
  ...
  ![_images/sparse-mma-168128-u4s4-A-first64col.png](img/Figure-140-Sparse-MMA-m16n8k128-fragment-layout-for-columns-0â63-of-matrix-A-withu4s4e2m1type.png)

  *Figure 140 Sparse MMA .m16n8k128 fragment layout for columns 0–63 of matrix A with.u4/.s4/.e2m1type.*

  ![_images/sparse-mma-168128-u4s4-A-last64col.png](img/Figure-141-Sparse-MMA-m16n8k128-fragment-layout-for-columns-64â127-of-matrix-A-withu4s4e2m1type.png)

  *Figure 141 Sparse MMA .m16n8k128 fragment layout for columns 64–127 of matrix A with.u4/.s4/.e2m1type.*
...
* Multiplicand B:
  ...
  ![_images/sparse-mma-168128-u4s4-B1.png](img/Figure-142-Sparse-MMA-m16n8k128-fragment-layout-for-rows-0â31-of-matrix-B-withu4s4e2m1type.png)

  *Figure 142 Sparse MMA .m16n8k128 fragment layout for rows 0–31 of matrix B with.u4/.s4/.e2m1type.*

  ![_images/sparse-mma-168128-u4s4-B2.png](img/Figure-143-Sparse-MMA-m16n8k128-fragment-layout-for-rows-32â63-of-matrix-B-withu4s4e2m1type.png)

  *Figure 143 Sparse MMA .m16n8k128 fragment layout for rows 32–63 of matrix B with.u4/.s4/.e2m1type.*

  ![_images/sparse-mma-168128-u4s4-B3.png](img/Figure-144-Sparse-MMA-m16n8k128-fragment-layout-for-rows-64â95-of-matrix-B-withu4s4e2m1type.png)

  *Figure 144 Sparse MMA .m16n8k128 fragment layout for rows 64–95 of matrix B with.u4/.s4/.e2m1type.*

  ![_images/sparse-mma-168128-u4s4-B4.png](img/Figure-145-Sparse-MMA-m16n8k128-fragment-layout-for-rows-96â127-of-matrix-B-withu4s4e2m1type.png)

  *Figure 145 Sparse MMA .m16n8k128 fragment layout for rows 96–127 of matrix B with.u4/.s4/.e2m1type.*
...
* Metadata: A `.b32` register containing 16 2-bit vectors with each pair of 2-bit vectors storing
  ...
  > ![_images/sparse-mma-metadata-168128-u4s4-first64col.png](img/Figure-146-Sparse-MMA-m16n8k128-metadata-layout-for-columns-0â63-foru4s4e2m1type.png)
  >
  > *Figure 146 Sparse MMA .m16n8k128 metadata layout for columns 0–63 for.u4/.s4/.e2m1type.*
  >
  > ![_images/sparse-mma-metadata-168128-u4s4-last64col.png](img/Figure-147-Sparse-MMA-m16n8k128-metadata-layout-for-columns-64â127-foru4s4e2m1type.png)
  >
  > *Figure 147 Sparse MMA .m16n8k128 metadata layout for columns 64–127 for.u4/.s4/.e2m1type.*

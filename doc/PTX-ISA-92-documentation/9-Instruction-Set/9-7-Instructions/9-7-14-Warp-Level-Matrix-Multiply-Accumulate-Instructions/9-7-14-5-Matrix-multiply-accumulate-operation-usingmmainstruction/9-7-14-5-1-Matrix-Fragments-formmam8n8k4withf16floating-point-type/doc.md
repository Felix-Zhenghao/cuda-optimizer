...
* Multiplicand A:
  ...
  + Fragment layout for Row Major matrix A is shown in [Figure 46](#mma-884-a-row-f16).
    ...
    ![_images/mma-884-A-row-f16.png](img/Figure-46-MMA-m8n8k4-fragment-layout-for-row-major-matrix-A-withf16type.png)

    *Figure 46 MMA .m8n8k4 fragment layout for row-major matrix A with.f16type*
  ...
  + Fragment layout for Column Major matrix A is shown in [Figure 47](#mma-884-a-col-f16).
    ...
    ![_images/mma-884-A-col-f16.png](img/Figure-47-MMA-m8n8k4-fragment-layout-for-column-major-matrix-A-withf16type.png)

    *Figure 47 MMA .m8n8k4 fragment layout for column-major matrix A with.f16type*
...
* Multiplicand B:
  ...
  + Fragment layout for Row Major matrix B is shown in [Figure 48](#mma-884-b-row-f16).
    ...
    ![_images/mma-884-B-row-f16.png](img/Figure-48-MMA-m8n8k4-fragment-layout-for-row-major-matrix-B-withf16type.png)

    *Figure 48 MMA .m8n8k4 fragment layout for row-major matrix B with.f16type*
  ...
  + Fragment layout for Column Major matrix B is shown in [Figure 49](#mma-884-b-col-f16).
    ...
    ![_images/mma-884-B-col-f16.png](img/Figure-49-MMA-m8n8k4-fragment-layout-for-column-major-matrix-B-withf16type.png)

    *Figure 49 MMA .m8n8k4 fragment layout for column-major matrix B with.f16type*
...
* Accumulators C (or D):
  ...
  + Fragment layout for accumulator matrix when `.ctype` is `.f16` is shown in [Figure 50](#mma-884-c-f16).
    ...
    ![_images/mma-884-C-f16.png](img/Figure-50-MMA-m8n8k4-fragment-layout-for-matrix-CD-withctypef16.png)
  ...
  + Fragment layout for accumulator matrix when `.ctype` is `.f32` is shown in
    ...
    ![_images/mma-884-C-f32-1.png](img/Figure-51-MMA-m8n8k4-computation-1-and-2-fragment-layout-for-matrix-CD-withctypef32.png)

    *Figure 51 MMA .m8n8k4 computation 1 and 2 fragment layout for matrix C/D with.ctype=.f32*

    ![_images/mma-884-C-f32-2.png](img/Figure-52-MMA-m8n8k4-computation-3-and-4-fragment-layout-for-matrix-CD-withctypef32.png)

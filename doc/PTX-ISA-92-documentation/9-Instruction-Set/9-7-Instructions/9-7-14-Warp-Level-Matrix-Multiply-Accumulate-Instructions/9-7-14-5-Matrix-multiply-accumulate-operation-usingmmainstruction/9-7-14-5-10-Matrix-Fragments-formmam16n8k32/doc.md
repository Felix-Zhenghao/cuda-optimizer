...
* Multiplicand A:
  ...
  + `.s4` or `.u4` :
    ...
    >
    > ![_images/mma-16832-A-i4.png](img/Figure-87-MMA-m16n8k32-fragment-layout-for-matrix-A-withu4s4type.png)
    >
    > *Figure 87 MMA .m16n8k32 fragment layout for matrix A with.u4/.s4type.*
    >
  ...
  + `.s8` or `.u8` or `.e4m3` or `.e5m2` or `.e3m2` or `.e2m3` or `.e2m1`:
    ...
    >
    > ![_images/mma-16832-A-i8.png](img/Figure-88-MMA-m16n8k32-fragment-layout-for-matrix-A-withu8s8e4m3e5m2e3m2e2m3e2m1type.png)
    >
    > *Figure 88 MMA .m16n8k32 fragment layout for matrix A with.u8/.s8/.e4m3/.e5m2/.e3m2/.e2m3/.e2m1type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
...
* Multiplicand B:
  ...
  + `.s4` or `.u4` :
    ...
    >
    > ![_images/mma-16832-B-i4.png](img/Figure-89-MMA-m16n8k32-fragment-layout-for-matrix-B-withu4s4type.png)
    >
    > *Figure 89 MMA .m16n8k32 fragment layout for matrix B with.u4/.s4type.*
    >
    > The row and column of a matrix fragment can be computed as:
  ...
  + `.s8` or `.u8` or `.e4m3` or `.e5m2` or `.e3m2` or `.e2m3` or `.e2m1`:
    ...
    >
    > ![_images/mma-16832-B-i8_1.png](img/Figure-90-MMA-m16n8k32-fragment-layout-for-rows-0â15-of-matrix-B-withu8s8e4m3e5m2e3m2e2m3e2m1type.png)
    >
    > *Figure 90 MMA .m16n8k32 fragment layout for rows 0–15 of matrix B with.u8/.s8/.e4m3/.e5m2/.e3m2/.e2m3/.e2m1type.*
    >
    > ![_images/mma-16832-B-i8_2.png](img/Figure-91-MMA-m16n8k32-fragment-layout-for-rows-16â31-of-matrix-B-withu8s8e4m3e5m2e3m2e2m3e2m1type.png)
    >
    > *Figure 91 MMA .m16n8k32 fragment layout for rows 16–31 of matrix B with.u8/.s8/.e4m3/.e5m2/.e3m2/.e2m3/.e2m1type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
...
* Accumulators (C or D):
  ...
  ![_images/mma-16832-C.png](img/Figure-92-MMA-m16n8k32-fragment-layout-for-accumulator-matrix-CD-withs32f32f16type.png)

  *Figure 92 MMA .m16n8k32 fragment layout for accumulator matrix C/D with.s32/.f32/.f16type.*

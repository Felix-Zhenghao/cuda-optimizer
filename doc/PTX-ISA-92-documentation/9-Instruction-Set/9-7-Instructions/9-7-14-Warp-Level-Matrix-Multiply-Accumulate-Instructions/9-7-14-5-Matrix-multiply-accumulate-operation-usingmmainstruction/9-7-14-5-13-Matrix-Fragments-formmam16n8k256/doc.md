...
* Multiplicand A:
  ...
  ![_images/mma-168256-A.png](img/Figure-100-MMA-m16n8k256-fragment-layout-for-matrix-A-withb1type.png)

  *Figure 100 MMA .m16n8k256 fragment layout for matrix A with.b1type.*
...
* Multiplicand B:
  ...
  ![_images/mma-168256-B_1.png](img/Figure-101-MMA-m16n8k256-fragment-layout-for-rows-0â127-of-matrix-B-withb1type.png)

  *Figure 101 MMA .m16n8k256 fragment layout for rows 0–127 of matrix B with.b1type.*

  ![_images/mma-168256-B_2.png](img/Figure-102-MMA-m16n8k256-fragment-layout-for-rows-128â255-of-matrix-B-withb1type.png)

  *Figure 102 MMA .m16n8k256 fragment layout for rows 128–255 of matrix B with.b1type.*
...
* Accumulators (C or D):
  ...
  ![_images/mma-168256-C.png](img/Figure-103-MMA-m16n8k256-fragment-layout-for-accumulator-matrix-CD-withs32type.png)

  *Figure 103 MMA .m16n8k256 fragment layout for accumulator matrix C/D with.s32type.*

...
![_images/tensor-im2col-mode-bounding-box1.png](img/Figure-11im2col-mode-bounding-box-example-1.png)

*Figure 11im2col mode bounding box example 1*

![_images/tensor-im2col-mode-bounding-box2.png](img/Figure-12im2col-mode-bounding-box-example-2.png)
...
* Example 1 ([Figure 13](#tensor-im2col-mode-example1)):
  ...
  ![_images/tensor-im2col-mode-example1.png](img/Figure-13im2col-mode-example-1.png)
...
* Example 2 ([Figure 14](#tensor-im2col-mode-example2)):
  ...
  ![_images/tensor-im2col-mode-example2.png](img/Figure-14im2col-mode-example-2.png)

...
This guide will focus on the CuTe ABI AOT. For the Apache TVM FFI AOT, please refer to the section "Exporting Compiled Module" in [Compile with TVM FFI](compile_with_tvm_ffi.html).
...
For more information, see the section "Exporting Compiled Module" in [Compile with TVM FFI](compile_with_tvm_ffi.html).

# Programming Guidelines - Style and Conventions
...
Use the
[fundamental types and operations](fundamental_types.html)
...
* [Numeric types](fundamental_types.html#numeric-types) to represent numeric data in host and device code, and
* [functional.h](fundamental_types.html#functional) to perform numeric operations in generic code.

CUTLASS 3.0 uses CuTe components to represent data layouts and multidimensional arrays.
Please refer to the [CuTe Tutorial](cute/00_quickstart.html) for details.
CuTe has replaced CUTLASS 2.x components such as
[Containers](fundamental_types.html#containers),
[Layouts](layout.html), and
[`TensorRef` and `TensorView`](layout.html#tensorref).

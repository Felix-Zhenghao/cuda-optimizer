...
* 32 byte swizzle mode:
  ...
  ![_images/tensor-32B-swizzle.png](img/Figure-2532-byte-swizzle-mode-example.png)
  ...
  *Figure 2532-byte swizzle mode example*
  ...
  ![_images/tensor-32B-swizzle-frag.png](img/Figure-2632-byte-swizzle-mode-fragments.png)
  ...
  *Figure 2632-byte swizzle mode fragments*
  ...
  ![_images/tensor-32B-swizzle-dst.png](img/Figure-2732-byte-swizzle-mode-destination-data-layout.png)
...
* 64 byte swizzle mode:
  ...
  ![_images/tensor-64B-swizzle.png](img/Figure-2864-byte-swizzle-mode-example.png)
  ...
  *Figure 2864-byte swizzle mode example*
  ...
  ![_images/tensor-64B-swizzle-src.png](img/Figure-2964-byte-swizzle-mode-source-data-layout.png)
  ...
  *Figure 2964-byte swizzle mode source data layout*
  ...
  ![_images/tensor-64B-swizzle-dst.png](img/Figure-3064-byte-swizzle-mode-destination-data-layout.png)
...
* 96 byte swizzle mode:
  ...
  ![_images/tensor-96B-swizzle.png](img/Figure-3196-byte-swizzle-mode-example.png)
...
* 128 byte swizzle mode:
  ...
  ![_images/tensor-128B-swizzle.png](img/Figure-32128-byte-swizzle-mode-example.png)
  ...
  *Figure 32128-byte swizzle mode example*
  ...
  ![_images/tensor-128B-swizzle-src.png](img/Figure-33128-byte-swizzle-mode-source-data-layout.png)
  ...
  *Figure 33128-byte swizzle mode source data layout*
  ...
  ![_images/tensor-128B-swizzle-dst.png](img/Figure-34128-byte-swizzle-mode-destination-data-layout.png)
  ...
  *Figure 34128-byte swizzle mode destination data layout*
  ...
  + 32-byte atomicity sub-mode:
    ...
    ![_images/tensor-128B-swizzle-32B-atom.png](img/Figure-35128-byte-swizzle-mode-example-with-32-byte-atomicity.png)
  ...
  + 32-byte atomicity with 8-byte flip sub-mode:
    ...
    Note that this mode is legal only when `cp.async.bulk.tensor` specifies the copy direction as
    `.shared::cluster.global` or otherwise `.shared::cta.global`.
    ...
    ![_images/tensor-128B-swizzle-32B-atom-8B-flip.png](img/Figure-36128-byte-swizzle-mode-example-with-32-byte-atomicity-with-8-byte-flip.png)
  ...
  + 64-byte atomicity sub-mode:
    ...
    ![_images/tensor-128B-swizzle-64B-atom.png](img/Figure-37128-byte-swizzle-mode-example-with-64-byte-atomicity.png)

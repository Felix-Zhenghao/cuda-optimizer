...
![Grid with CTAs](img/Figure-1-Grid-with-CTAs.png)

*Figure 1 Grid with CTAs*

![Grid with clusters](img/Figure-2-Grid-with-clustersA-cluster-is-a-set-of-cooperative-thread-arrays-CTAs-where-a-CTA-is-a-set-of-concurrent-threa.png)

*Figure 2 Grid with clustersA cluster is a set of cooperative thread arrays (CTAs) where a CTA is a set of concurrent threads

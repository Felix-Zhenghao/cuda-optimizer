...
* Multiplicand A:
  ...
  + `.f16` and `.bf16` :
    ...
    >
    > ![_images/mma-16816-A-f16.png](img/Figure-79-MMA-m16n8k16-fragment-layout-for-matrix-A-withf16bf16type.png)
    >
    > *Figure 79 MMA .m16n8k16 fragment layout for matrix A with.f16/.bf16type.*
    >
  ...
  + `.f64` :
    ...
    >
    > ![_images/mma-16816-A-f64.png](img/Figure-80-MMA-m16n8k16-fragment-layout-for-matrix-A-withf64type.png)
    >
    > *Figure 80 MMA .m16n8k16 fragment layout for matrix A with.f64type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
...
* Multiplicand B:
  ...
  + `.f16` and `.bf16` :
    ...
    >
    > ![_images/mma-16816-B-f16.png](img/Figure-81-MMA-m16n8k16-fragment-layout-for-matrix-B-withf16bf16type.png)
    >
    > *Figure 81 MMA .m16n8k16 fragment layout for matrix B with.f16/.bf16type.*
    >
  ...
  + `.f64` :
    ...
    >
    > ![_images/sparse-mma-16816-tf32-B.png](img/Figure-82-MMA-m16n8k16-fragment-layout-for-matrix-B-withf64type.png)
    >
    > *Figure 82 MMA .m16n8k16 fragment layout for matrix B with.f64type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
...
* Accumulators (C or D):
  ...
  ![_images/mma-16816-C-f16.png](img/Figure-83-MMA-m16n8k16-fragment-layout-for-accumulator-matrix-matrix-CD.png)

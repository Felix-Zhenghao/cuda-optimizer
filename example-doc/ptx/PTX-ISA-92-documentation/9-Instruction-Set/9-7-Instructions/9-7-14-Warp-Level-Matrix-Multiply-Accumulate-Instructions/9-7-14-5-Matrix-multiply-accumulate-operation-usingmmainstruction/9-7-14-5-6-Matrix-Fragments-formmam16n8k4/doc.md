...
* Multiplicand A:
  ...
  + `.tf32`:
    ...
    ![_images/mma-1684-A.png](img/Figure-65-MMA-m16n8k4-fragment-layout-for-matrix-A-withtf32type.png)

    *Figure 65 MMA .m16n8k4 fragment layout for matrix A with.tf32type.*
  ...
  + `.f64`:
    ...
    >
    > ![_images/mma-1684-A.png](img/Figure-66-MMA-m16n8k4-fragment-layout-for-matrix-A-withf64type.png)
    >
    > *Figure 66 MMA .m16n8k4 fragment layout for matrix A with.f64type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
...
* Multiplicand B:
  ...
  + `.tf32`:
    ...
    >
    > ![_images/mma-1684-B.png](img/Figure-67-MMA-m16n8k4-fragment-layout-for-matrix-B-withtf32type.png)
    >
    > *Figure 67 MMA .m16n8k4 fragment layout for matrix B with.tf32type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
  ...
  + `.f64`:
    ...
    >
    > ![_images/mma-1684-B.png](img/Figure-68-MMA-m16n8k4-fragment-layout-for-matrix-B-withf64type.png)
    >
    > *Figure 68 MMA .m16n8k4 fragment layout for matrix B with.f64type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
...
* Accumulators (C or D):
  ...
  + `.tf32`:
    ...
    >
    > ![_images/mma-1684-C.png](img/Figure-69-MMA-m16n8k4-fragment-layout-for-accumulator-matrix-CD-withf32type.png)
    >
    > *Figure 69 MMA .m16n8k4 fragment layout for accumulator matrix C/D with.f32type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
  ...
  + `.f64`:
    ...
    >
    > ![_images/mma-1684-C.png](img/Figure-70-MMA-m16n8k4-fragment-layout-for-accumulator-matrix-CD-withf64type.png)
    >
    > *Figure 70 MMA .m16n8k4 fragment layout for accumulator matrix C/D with.f64type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```

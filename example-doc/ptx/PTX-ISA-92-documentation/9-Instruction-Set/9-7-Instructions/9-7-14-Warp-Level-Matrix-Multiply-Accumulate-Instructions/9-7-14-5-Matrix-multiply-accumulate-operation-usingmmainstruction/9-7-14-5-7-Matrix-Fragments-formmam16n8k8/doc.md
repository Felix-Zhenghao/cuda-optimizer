...
* Multiplicand A:
  ...
  + `.f16` and `.bf16` :
    ...
    >
    > ![_images/mma-1688-A-f16.png](img/Figure-71-MMA-m16n8k8-fragment-layout-for-matrix-A-withf16bf16type.png)
    >
    > *Figure 71 MMA .m16n8k8 fragment layout for matrix A with.f16/.bf16type.*
    >
  ...
  + `.tf32` :
    ...
    >
    > ![_images/mma-1688-A-tf32.png](img/Figure-72-MMA-m16n8k8-fragment-layout-for-matrix-A-withtf32type.png)
    >
    > *Figure 72 MMA .m16n8k8 fragment layout for matrix A with.tf32type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
  ...
  + `.f64` :
    ...
    ![_images/mma-1688-A-tf32.png](img/Figure-73-MMA-m16n8k8-fragment-layout-for-matrix-A-withf64type.png)

    *Figure 73 MMA .m16n8k8 fragment layout for matrix A with.f64type.*
...
* Multiplicand B:
  ...
  + `.f16` and `.bf16` :
    ...
    >
    > ![_images/mma-1688-B-f16.png](img/Figure-74-MMA-m16n8k8-fragment-layout-for-matrix-B-withf16bf16type.png)
    >
    > *Figure 74 MMA .m16n8k8 fragment layout for matrix B with.f16/.bf16type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
  ...
  + `.tf32` :
    ...
    >
    > ![_images/mma-1688-B-tf32.png](img/Figure-75-MMA-m16n8k8-fragment-layout-for-matrix-B-withtf32type.png)
    >
    > *Figure 75 MMA .m16n8k8 fragment layout for matrix B with.tf32type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
  ...
  + `.f64` :
    ...
    >
    > ![_images/mma-1688-B-tf32.png](img/Figure-76-MMA-m16n8k8-fragment-layout-for-matrix-B-withf64type.png)
    >
    > *Figure 76 MMA .m16n8k8 fragment layout for matrix B with.f64type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
...
* Accumulators (C or D):
  ...
  + `.f16`, `.bf16` and `.tf32`:
    ...
    >
    > ![_images/mma-1688-C.png](img/Figure-77-MMA-m16n8k8-fragment-layout-for-accumulator-matrix-CD-withf16x2f32type.png)
    >
    > *Figure 77 MMA .m16n8k8 fragment layout for accumulator matrix C/D with.f16x2/.f32type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```
  ...
  + `.f64` :
    ...
    >
    > ![_images/mma-1688-C.png](img/Figure-78-MMA-m16n8k8-fragment-layout-for-accumulator-matrix-CD-withf64type.png)
    >
    > *Figure 78 MMA .m16n8k8 fragment layout for accumulator matrix C/D with.f64type.*
    >
    > The row and column of a matrix fragment can be computed as:
    >
    > ```

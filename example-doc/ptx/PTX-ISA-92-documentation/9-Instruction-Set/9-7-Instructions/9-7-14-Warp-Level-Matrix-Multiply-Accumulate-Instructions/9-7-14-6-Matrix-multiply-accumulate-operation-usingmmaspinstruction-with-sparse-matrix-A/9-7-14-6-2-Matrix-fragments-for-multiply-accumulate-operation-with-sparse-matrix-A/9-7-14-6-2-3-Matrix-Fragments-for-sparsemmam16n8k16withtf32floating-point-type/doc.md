...
* Multiplicand A:
  ...
  ![_images/sparse-mma-16816-tf32-A.png](img/Figure-123-Sparse-MMA-m16n8k16-fragment-layout-for-matrix-A-withtf32type.png)

  *Figure 123 Sparse MMA .m16n8k16 fragment layout for matrix A with.tf32type.*
...
* Multiplicand B:
  ...
  ![_images/sparse-mma-16816-tf32-B.png](img/Figure-124-Sparse-MMA-m16n8k16-fragment-layout-for-matrix-B-withtf32type.png)

  *Figure 124 Sparse MMA .m16n8k16 fragment layout for matrix B with.tf32type.*
...
* Metadata: A `.b32` register containing 8 4-bit vectors each storing the index of a non-zero
  ...
  > ![_images/sparse-mma-metadata-16816-tf32.png](img/Figure-125-Sparse-MMA-m16n8k16-metadata-layout-fortf32type.png)
  >
  > *Figure 125 Sparse MMA .m16n8k16 metadata layout for.tf32type.*

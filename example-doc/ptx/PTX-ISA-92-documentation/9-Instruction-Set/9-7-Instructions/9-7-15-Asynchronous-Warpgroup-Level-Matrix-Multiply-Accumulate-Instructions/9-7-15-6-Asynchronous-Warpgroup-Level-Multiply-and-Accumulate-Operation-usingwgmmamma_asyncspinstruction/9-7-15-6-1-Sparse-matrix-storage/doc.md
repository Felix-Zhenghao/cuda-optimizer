...
![_images/f16-metadata-example.png](img/Figure-171-Sparse-WGMMA-metadata-example-forf16bf16type.png)

*Figure 171 Sparse WGMMA metadata example for.f16/.bf16type.*
...
![_images/tf32-metadata-example.png](img/Figure-172-Sparse-WGMMA-metadata-example-fortf32type.png)

*Figure 172 Sparse WGMMA metadata example for.tf32type.*
...
![_images/u8s8-metadata-example.png](img/Figure-173-Sparse-WGMMA-metadata-example-fore4m3e5m2type.png)

*Figure 173 Sparse WGMMA metadata example for.e4m3/.e5m2type.*
...
![_images/u8s8-metadata-example.png](img/Figure-174-Sparse-WGMMA-metadata-example-foru8s8type.png)

*Figure 174 Sparse WGMMA metadata example for.u8/.s8type.*

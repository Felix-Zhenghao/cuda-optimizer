...
1. Destination type `.f16`:
   ...
   ![_images/cvt-rs-rbits-layout-f16.png](img/Figure-38-Random-bits-layout-forrsrounding-withf16destination-type.png)

   *Figure 38 Random bits layout for.rsrounding with.f16destination type*
2. Destination type `.bf16`:
   Refer [Figure 39](#cvt-rs-rbits-layout-bf16) for random bits layout details.

   ![_images/cvt-rs-rbits-layout-bf16.png](img/Figure-39-Random-bits-layout-forrsrounding-withbf16destination-type.png)

   *Figure 39 Random bits layout for.rsrounding with.bf16destination type*
3. Destination type `.e2m1x4`:
   Refer [Figure 40](#cvt-rs-rbits-layout-f4) for random bits layout details.

   ![_images/cvt-rs-rbits-layout-f4.png](img/Figure-40-Random-bits-layout-forrsrounding-withe2m1x4destination-type.png)

   *Figure 40 Random bits layout for.rsrounding with.e2m1x4destination type*
4. Destination type `.e5m2x4`, `.e4m3x4`, `.e3m2x4`, `.e2m3x4`:
   Refer [Figure 41](#cvt-rs-rbits-layout-f8-f6) for random bits layout details.

   ![_images/cvt-rs-rbits-layout-f8-f6.png](img/Figure-41-Random-bits-layout-forrsrounding-withe5m2x4e4m3x4e3m2x4e2m3x4destination-type.png)

   *Figure 41 Random bits layout for.rsrounding with.e5m2x4/.e4m3x4/.e3m2x4/.e2m3x4destination type*
